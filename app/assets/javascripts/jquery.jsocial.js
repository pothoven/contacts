...
if( options.twitter ) {list += '<li><a title="http://twitter.com/' + options.twitter + '" href="http://twitter.com/' + options.twitter + '" class="twitter" ' + target + '>Twitter</a></li>'; total_links ++;};

if( options.facebook ) {list += '<li><a title="http://' + options.facebook + '" href="http://' + options.facebook + '" class="facebook" ' + target + ' >Facebook</a></li>'; total_links ++;};

if( options.flickr ) {list += '<li><a title="http://flickr.com/' + options.flickr + '" href="http://flickr.com/' + options.flickr + '" class="flickr" ' + target + ' >Flickr</a></li>'; total_links ++;};

if( options.friendfeed ) {list += '<li><a title="http://friendfeed.com/' + options.friendfeed + '" href="http://friendfeed.com/' + options.friendfeed + '" class="friendfeed" ' + target + ' >FriendFeed</a></li>'; total_links ++;};

if( options.delicious ) {list += '<li><a title="http://delicious.com/' + options.delicious + '" href="http://delicious.com/' + options.delicious + '" class="delicious" ' + target + ' >Delicious</a></li>'; total_links ++;};

if( options.digg ) {list += '<li><a title="http://digg.com/users/' + options.digg + '" href="http://digg.com/users/' + options.digg + '" class="digg" ' + target + ' >Digg</a></li>'; total_links ++;};

if( options.lastfm ) {list += '<li><a title="http://www.last.fm/user/' + options.lastfm + '" href="http://www.last.fm/user/' + options.lastfm + '" class="lastfm" ' + target + ' >Last.FM</a></li>'; total_links ++;};

if( options.linked ) {list += '<li><a title="http://' + options.linked + '" href="http://' + options.linked + '" class="linked-in" ' + target + ' >Linked-In</a></li>'; total_links ++;};

if( options.youtube ) {list += '<li><a title="http://' + options.youtube + '" href="http://' + options.youtube + '" class="youtube" ' + target + ' >YouTube</a></li>'; total_links ++;};

if( options.feed ) {list += '<li><a title="http://feeds.feedburner.com/' + options.feed + '" href="http://feeds.feedburner.com/' + options.feed + '" class="feed" ' + target + ' >Feedburner</a></li>'; total_links ++;};

if( options.other ) {list += '<li><a title="' + options.other + '" href="' + options.other + '" class="other" ' + target + ' >Other</a></li>'; total_links ++;};
